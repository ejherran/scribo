...
class DosController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        {
            return $this->render('ScriboBundle:Dos:index.html.twig');
        }
        else
        {
    ...
    public function visorAction($id)
    {
        if(Gestion::isGrant($this, 'A'))
        {
            return $this->render('ScriboBundle:Dos:visor.html.twig', array('URL' => $this->generateUrl('scribo_dos_docu', array('id' => $id))));
        }
        else
        {
            $this->get('session')->getFlashBag()->add('notice', 'Intento de acceso no autorizado!...');
    ...
    public function docuAction($id)
    {
        if(Gestion::isGrant($this, 'A'))
        {
            ...
            $pdf->SetTitle('Comprobante De Ordenes Tipo II');
            ...
            $pdf->setTabl(true);
            $pdf->setMemoTitle("COMPROBANTE DE ORDENES TIPO II");
